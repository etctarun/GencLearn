    ...
    do {
      ...
      switch (option) {
        case 1:
          ...
          FruitBasket fbObj = new FruitBasket(
            fruitName,
            weightInKgs,
            pricePerKg
          );
        ...
        case 2:
          // Fill your code here
          if (utilObj.getFruitBasketList().isEmpty()) {
            System.out.println("Your basket is empty. Please add fruits.");
            break;
          }
          Stream<FruitBasket> fruitBasketStream = utilObj
            .getFruitBasketList()
            .stream();
          int totalBill = utilObj.calculateBill(fruitBasketStream);
